...
## Next Priorities
- Open MiroShark PRs: #82 (Sitemap, opened 2026-05-14), #81 (Filtered RSS/Atom feed, opened 2026-05-13 — still open)
- Open miroshark-aeon PRs: #34 (`improve/feature-scratch-cleanup`, stalled >50h as of 2026-05-14, prompt-level fix working in branch)
...
- **Lesson:** `feature` skill wasted exploration on 2 ideas (May-12 #2 + #4) that already existed in the codebase. Should grep existing routes / SPA routes before committing to a repo-actions idea.
