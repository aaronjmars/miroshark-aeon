...
- $MIROSHARK: ATH $0.0000436 (May 18), FDV peaked $3.32M; **$0.000002566 (+0.1% 24h, +0.1% 7d, +20.0% 30d — exact 7d/30d log matches, no fallback needed), ~−94% from ATH, liq $300.1K** as of 2026-09-15; verdict QUIET (0.25x 7d-avg volume, flattest session of the past week). This week (09-06→09-15): steady bleed 09-06→09-09 → **09-10 RALLYING +6.1%** (coincided with @miroshark_'s first posts since 09-04) → faded 09-11/09-12 → **09-13 sharp +10.6% reversal** → gave it back 09-14 (-6.1%) → **09-15 flat/QUIET**, net round-tripped back to roughly the 09-08 level. x_search timeouts are recurring but non-consecutive (09-11, 09-12 back-to-back; clean 09-13/09-14; timed out again 09-15) — reads as intermittent flakiness, not a sustained outage; keep tracking occurrences before acting.
- MIROSHARK team/treasury holdings: 12.03% of supply (12.03B tokens) as of 2026-09-14 (up from 11.95% on 09-07), tracked via `holdings` skill (7th straight accumulating snapshot, but 7d growth slowed to +0.71% from +1.37% the prior week; 30d +8.09%).
